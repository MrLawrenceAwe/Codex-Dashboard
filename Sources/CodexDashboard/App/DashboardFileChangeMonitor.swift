...
final class DashboardFileChangeMonitor {
    ...
    static func gitMetadataURL(for projectURL: URL) -> URL? {
        ...
        while true {
            ...
            if FileManager.default.fileExists(atPath: gitURL.path, isDirectory: &isDirectory) {
                ...
                return linkedGitMetadataURL(from: gitURL)
            }
    ...
    private static func linkedGitMetadataURL(from pointerURL: URL) -> URL? {
        guard

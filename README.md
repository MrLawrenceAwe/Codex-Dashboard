...
- Threads are grouped into collapsible projects. **Running** is the default dashboard view, alongside focused **Unread** and **Changed projects** filters. Search narrows the currently selected view.

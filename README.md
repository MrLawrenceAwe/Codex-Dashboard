...
- macOS notifications are scheduled one hour before every known five-hour and weekly reset. Each alert identifies the account and reports its latest remaining usage percentage.
